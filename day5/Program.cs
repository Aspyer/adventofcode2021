...
namespace day5
{
    internal class Program
    {
        ...
        {
            int[,] seaworld = new int[1000, 1000];
            var regels = System.IO.File.ReadAllLines(@"C:\Users\basdu\Downloads\day52021adventofcode.txt");
